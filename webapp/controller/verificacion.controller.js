sap.ui.define([
	...
	var superarr = [];
	var oMessagePopover;
	return Controller.extend("AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.controller.verificacion", {
		...
		handleValueHelp: function (oEvent) {
			...
			if (!this._valueHelpDialog) {
				this._valueHelpDialog = sap.ui.xmlfragment(
					"AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.view.PopUpdescartadosInmovilizado",
					this
				);
		...
		EnvioCorreo: function (evt) {
			...
			if (!oDialog) {
				...
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.view.Correo", this);
		...
		popSuccesCorreo: function (obj, titulo) {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.view.SuccesCorreo", this); //aqui se debe cambiar ar_dp_rep
				oView.addDependent(oDialog);
			}
  ...
  var appModulePath = jQuery.sap.getModulePath(appid);
		...
		popCarga: function () {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.view.PopUp", this);
				oView.addDependent(oDialog);
			}
			oDialog.open();
			//	oView.byId("textCarga").setText(titulo);
		...
		PopUPcorrecto: function (obj, titulo) {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.view.correcto", this);
				oView.addDependent(oDialog);
			}
		...
		popSucces: function (obj, titulo) {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.view.Succes", this);
				oView.addDependent(oDialog);
			}
		...
		popError: function (obj, titulo) {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.view.Error", this);
				oView.addDependent(oDialog);
			}
		...
		popError3: function (obj, titulo) {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.view.Error3", this);
				oView.addDependent(oDialog);
			}
		...
		atras: function () {
			...
			// console.log(destino);
			// console.log(vin);
			sap.ui.controller("AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.controller.Creacion").jsoncreacion(2);
			var oRouter = this.getOwnerComponent().getRouter();
			oRouter.navTo("Creacion");
		},
		homee: function () {
			var a = "a";
			sap.ui.controller("AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.controller.Creacion").jsoncreacion2(a);
			// var oRouter = this.getOwnerComponent().getRouter();
			// oRouter.navTo("Creacion");
			var oRouter =
				sap.ui.core.UIComponent.getRouterFor(this);
