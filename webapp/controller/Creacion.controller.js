sap.ui.define([
	...
	var mnext = [],
		msext = [];
	return Controller.extend("AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.controller.Creacion", {
		onInit: function () {
			jQuery.sap.require("AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.js.jszip");
			jQuery.sap.require("AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.js.xlsx");
			var oRouter =
		...
		handleValueHelp: function (oEvent) {
			...
			if (!this._valueHelpDialog) {
				this._valueHelpDialog = sap.ui.xmlfragment("AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.view.DialogIM",
					this
				);
		...
		Verificado: function () {
			...
			sap.ui.controller("AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.controller.verificacion").jsoncreacion(ID_SOLICITANTE, a,
				b, c, d, f, g, h);
		...
		popformulario: function () {
			...
			if (!oDialog) {
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PREORDENCREACION_EXPO.AR_DP_REP_PREORDENCREACION_EXPO.view.formulario", this);
				oView.addDependent(oDialog);
